						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_form" method="post" action="{{route('color.store')}}" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                    @csrf
                    <!--begin::کناری column-->
                                ...
                                <div class="row">
                                  <div class="mb-10 fv-row col-4">
  																	...
  																	<input type="color" name="color" class="form-control mb-2" value="" required/>
  																</div>
